        ...
        <div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                        ...
                        <g id="freepik--character-1--inject-2">
                            ...
                            <path
                                ...
                                style={{fill: '#263238'}}></path>
                            <path d="M203.31,139.53l1.5-.69S204.19,140.19,203.31,139.53Z"
                                  style={{fill: '#263238'}}></path>
                            ...
                            <path
                                ...
                                style={{fill: '#E5BDBD'}}></path>
                            <path d="M195.93,140.67l1.5-.69S196.82,141.32,195.93,140.67Z"
                                  style={{fill: '#263238'}}></path>
                            <path
            ...
            <section id="login-section">
                <div id="login-form-wrapper" className="animate__animated animate__lightSpeedInLeft">
                    ...
                    <div id="sign-up-div">Don't have an account ? <span id="sign-up-button"><Link to={'/signup'}>Sign Up here</Link></span>
                    </div>
                </div>
            </section>
        </div>
